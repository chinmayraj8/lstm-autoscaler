...
- LSTM cost advantage mechanism: on m_2189 and m_2065 the LSTM wins cost by avoiding over-provisioning waste, but at the price of more SLA violations on m_2065. Tuning `under_prov_weight` more aggressively may close the SLA gap.
- m_2101 infeasible at any reasonable scale (p99=965% at 115% mean target); not addressable without a higher max_servers ceiling or burst-absorbing capacity tier.
- Burstiness hypothesis fully disconfirmed for SLA; partially holds for cost (mid-burstiness wins, not high-burstiness).
